"""
Django settings for test_indepo project.
...
SECRET_KEY = 'django-insecure-mi7n_gkjl8!3@hke6gn5ioqftx)!q=2tqv%6t=raa)43sazdo6'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, "test_indepo", "templates"),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
CMS_LANGUAGES = {
    1: [  # ID сайта, если мультисайтовость, то для каждого
        {
            'code': 'ru',
            'name': _('Russian'),
            'fallbacks': ['en'],
