"""
Django settings for indepo project.

Generated by 'djangocms' command using django CMS 5.0.2 and Django 5.2.5.
...
SECRET_KEY = 'django-insecure-=e7lfxlqtr6w5m7&3)ivpv3)vj^we#54g2dj8n7a_w%@&!z((y'
...
INSTALLED_APPS = [
    ...
    'djangocms_admin_style',  # Доп стили и прочее
    ...
    'sekizai',
    #'djangocms_text',
    'djangocms_text_ckeditor',  # Новый плагин для текста
    'indepo', # Наше приложение
    'djangocms_link',
    'djangocms_alias',
...
ROOT_URLCONF = 'indepo.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
            os.path.join(BASE_DIR, "indepo", "templates"),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'indepo.wsgi.application'
...
LANGUAGE_CODE = 'ru'  # Для русского языка

LANGUAGES = [
    ('ru', 'Russian'),
    # ('en', 'English'), если нужно несколько
]
...
#    ('index.html', 'Главная страница'),
    ...
    ('home.html', 'Главная страница Интеграл'),
    ('index.html', 'Template Bizland'),
)
...
DJANGOCMS_TEXT_EDITOR = 'ckeditor5'
